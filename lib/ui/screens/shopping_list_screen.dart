...
class ShoppingListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border(
              bottom: BorderSide(color: AppColors.outlineVariant.withAlpha(100)),
            ),
          ),
          child: SafeArea(
            bottom: false,
      ...
      // Use existing bottom nav from app layout if we had one extracted, 
      // but for now we won't add a Scaffold-level bottomNav unless needed globally.
      // Usually bottom navigation is handled by a shell route.
    );
  }
}
